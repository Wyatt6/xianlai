...
(200001, 200001, 'ri-group-fill', '身份认证和访问管理', 'IAM', 1, 'menu:iam', 1, 0),
(200002, 200002, 'ri-user-settings-fill', '用户管理', 'IAM_USER_MANAGE', 1, 'menu:iam_user_manage', 1, 200001),
(200003, 200003, 'ri-account-box-fill', '角色管理', 'IAM_ROLE_MANAGE', 1, 'menu:iam_role_manage', 1, 200001),
