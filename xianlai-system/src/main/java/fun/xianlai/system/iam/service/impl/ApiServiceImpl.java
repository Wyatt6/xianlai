...
import fun.xianlai.system.common.model.entity.SysApi;
import fun.xianlai.system.iam.repository.SysApiRepository;
...
public class ApiServiceImpl implements ApiService {
    ...
    @Override
    @ServiceLog("条件查询接口分页")
    public Page<SysApi> getPageConditionally(int pageNum, int pageSize, SysApi condition) {
