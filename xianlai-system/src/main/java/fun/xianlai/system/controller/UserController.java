...
import fun.xianlai.system.model.form.BindForm;
import fun.xianlai.system.model.form.ChangePasswordForm;
...
public class UserController {
    ...
    public RetResult getPageConditionally(@RequestParam("pageNum") int pageNum,
        ...
        Page<UserInfo> userInfoList = userService.getUserInfoPageConditionally(pageNum, pageSize, condition);
        return new RetResult().success()
