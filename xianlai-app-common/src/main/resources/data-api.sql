...
(12002, 'common.path.getPageConditionally', '条件查询路径分页', 'POST', '/api/common/path/getPageConditionally'),
(12003, 'common.path.getRowNumStartFrom1', '查询路径的排名（从1开始）', 'GET', '/api/common/path/getRowNumStartFrom1'),
-- ApiController
