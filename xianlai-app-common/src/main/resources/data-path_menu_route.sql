...
(13002, 13002, 'SETTING_REDIRECT', '/setting/path'),
(13003, 13003, 'SETTING_PATH', '/setting/path'),
(13004, 13004, 'SETTING_MENU', '/setting/menu'),
(13005, 13005, 'SETTING_ROUTE', '/setting/route'),
(13006, 13006, 'SETTING_OPTION', '/setting/option'),
(13007, 13007, 'SETTING_API', '/setting/api'),
-- 最终无匹配 --
