package fun.xianlai.microservice.iam.config;

import fun.xianlai.microservice.iam.properties.LettucePoolProperties;
import fun.xianlai.microservice.iam.properties.RedisProperties;
