...
import fun.xianlai.system.service.iam.model.entity.User;
...
public interface UserRepository extends JpaRepository<User, Long> {
    ...
    @Query("select distinct new fun.xianlai.system.iam.model.entity.other.UserInfo(" +
            "      u.id, u.username, u.registerAt, u.active, u.isDeleted, " +
            ...
            "      and (?2 is null or u.registerAt >= ?2) " +
            "      and (?3 is null or u.registerAt <= ?3) " +
            "      and (?4 is null or u.active = ?4) " +
            "      and (?5 is null or u.isDeleted = ?5) " +
