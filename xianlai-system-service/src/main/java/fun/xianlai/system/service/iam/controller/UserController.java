package fun.xianlai.system.service.iam.controller;
...
//    public RetResult register(@RequestBody SysUser form) {
//        BeanUtils.trimString(form);
...
//        }
//
//        SysUser user = userService.authentication(username, password);
...
//        SysProfile profile = userService.exportProfile(user.getId());
...
//        Page<SysUserInfo> userInfoList = userService.getUserInfoPageConditionally(pageNum, pageSize, condition);
//        return new RetResult().success()
...
//        log.info("请求参数: {}", form);
//        Optional<SysUser> user = userService.findByUserId(form.getUserId());
//        if (user.isEmpty()) {
...
//    public RetResult editUserInfo(@RequestBody SysUserInfo form) {
//        log.info("请求参数: {}", form);
