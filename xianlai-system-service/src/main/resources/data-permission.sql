...
-- ------------- --
-- 显示菜单
(10001, 10001, 'menu:setting', '【系统设置】菜单', null),
(10002, 10002, 'menu:setting_path', '【路径常量】菜单', null),
(10003, 10003, 'menu:setting_menu', '【菜单管理】菜单', null),
(10004, 10004, 'menu:setting_route', '【路由配置】菜单', null),
(10005, 10005, 'menu:setting_option', '【参数选项】菜单', null),
(10006, 10006, 'menu:setting_api', '【后端接口】菜单', null),
-- 路径 Path
...
-- 参数 Option
(15001, 15001, 'option:add', '添加参数', null),
(15002, 15002, 'option:delete', '删除参数', null),
(15003, 15003, 'option:edit', '修改参数', null),
(15004, 15004, 'option:query', '查询参数', null),

-- ---------- --
-- IAM模块权限 --
-- ---------- --
-- 显示菜单
(20001, 20001, 'menu:iam', '【身份认证和访问管理】菜单', null),
